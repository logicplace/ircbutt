...
msgs = {
	...
	"212-RPL_STATSCOMMANDS-1": [S2C,"<command> <count>"],
	"212-RPL_STATSCOMMANDS-2": [S2C,"<command> <count> <byteCount> <remoteCount>"],
	...
	"219-RPL_ENDOFSTATS": [S2C,"<letter> {message??:}"], // / difference in RFCs
	//"220-RPL_STATSPLINE"
	//"220-RPL_STATSBLINE"
	...
	"234-RPL_SERVLIST": [S2C,"<name> <server> <mask> <type> <hopCount> <info>"],
	"235-RPL_SERVLISTEND": [S2C,"<mask> <type> :End of service listing"],
	...
	"262-RPL_TRACEEND": [S2C,"<serverName> <versionAndDebug>  :End of TRACE"],
	//"262-RPL_TRACEPING"
	//"262-RPL_TRACEEND"
	"263-RPL_TRYAGAIN": [S2C,"<command> :Please wait a while and try again."],
	...
	"303-RPL_ISON-1": [S2C,":<nick>*?"],
	"303-RPL_ISON-2": [S2C,":<op:*1><nick>*?"],
	...
	"315-RPL_ENDOFWHO": [S2C,"<name> {message??:}"], // / difference in RFCs
	//"316-RPL_WHOISCHANOP" //deprecated
	"317-RPL_WHOISIDLE": [S2C,"<nick> <#seconds> :seconds idle"],
	"318-RPL_ENDOFWHOIS": [S2C,"<nick> {message??:}"], // / difference in RFCs
	...
	"323-RPL_LISTEND": [S2C,":{message??:}"], // / difference in RFCs
	"324-RPL_CHANNELMODEIS": [S2C,"<channel> <modes> <modeParams>*"],
	"325-RPL_UNIQOPIS": [S2C,"<channel> <nick>"],
	...
	//"345-RPL_INVITED"
	"346-RPL_INVITELIST": [S2C,"<channel> <inviteMask>"],
	"347-RPL_ENDOFINVITELIST": [S2C,"<channel> :End of channel invite list"],
	"348-RPL_EXCEPTLIST": [S2C,"<channel> <exceptionMask>"],
	"349-RPL_ENDOFEXCEPTLIST": [S2C,"<channel> :End of channel exception list"],
	...
	"365-RPL_ENDOFLINKS": [S2C,"<mask> {message??:}"], // / difference in RFCs
	"366-RPL_ENDOFNAMES": [S2C,"<channel> {message??:}"], // / difference in RFCs
	...
	"374-RPL_ENDOFINFO": [S2C,"{message??:}"], // / difference in RFCs
	"375-RPL_MOTDSTART": [S2C,":- <server> Message of the day - "],
	"376-RPL_ENDOFMOTD": [S2C,"{message??:}"], // / difference in RFCs
	...
	"383-RPL_YOURESERVICE": [S2C,"You are service <serviceName>"], // TODO s2c?
	...
	"407-ERR_TOOMANYTARGETS-1": [S2C,"<target> :Duplicate recipients. No message delivered"],
	"407-ERR_TOOMANYTARGETS-2": [S2C,"<target> :<errorCode> recipients. <abortMessage>"],
	"408-ERR_NOSUCHSERVICE": [S2C,"<serviceName> :No such service"],
	...
	"432-ERR_ERRONEOUSNICKNAME": [S2C,"<nick> :Erroneous nickname"],
	...
	//"435-ERR_BANONCHAN"
	"436-ERR_NICKCOLLISION-1": [S2C,"<nick> :Nickname collision KILL"],
	"436-ERR_NICKCOLLISION-2": [S2C,"<nick> :Nickname collision KILL from <user>@<host>"],
	"437-ERR_UNAVAILRESOURCE": [S2C,"<nickOrChannel> :Nick%/channel is temporarily unavailable"],
	...
	"462-ERR_ALREADYREGISTRED-1": [S2C,":You may not reregister"],
	"462-ERR_ALREADYREGISTRED-2": [S2C,":Unauthorized commaned %(already registered%)"],
	...
	"472-ERR_UNKNOWNMODE-1": [S2C,"<char> :is unknown mode char to me"],
	"472-ERR_UNKNOWNMODE-2": [S2C,"<char> :is unknown mode char to me for <channel>"],
	...
	"476-ERR_BADCHANMASK": [S2C,":Bad Channel Mask"],
	"477-ERR_NOCHANMODES": [S2C,":Channel doesn't support modes"],
	//"477-ERR_NEEDREGGEDNICK"
	"478-ERR_BANLISTFULL": [S2C,"<channel> <char> :Channel list is full"],
	//"479-ERR_BADCHANNAME"
	//"479-ERR_LINKFAIL"
	//"480-ERR_NOULINE"
	//"480-ERR_CANNOTKNOCK"
	...
	"484-ERR_RESTRICTED": [S2C,":Your connection is restricted!"],
	//"484-ERR_ISCHANSERVICE"
	//"484-ERR_DESYNC"
	//"484-ERR_ATTACKDENY"
	"485-ERR_UNIQOPPRIVSNEEDED": [S2C,":You're not the original channel operator"],
	//"485-ERR_KILLDENY"
	...
	"502-ERR_USERSDONTMATCH-1": [S2C,":Cant change mode for other users"],
	"502-ERR_USERSDONTMATCH-2": [S2C,":Cannot change mode for other users"],
	//"503-ERR_VWORLDWARN"
	...
	"PART-1": [C2S|S2C,"<,|channel>*"],
	"PART-2": [C2S|S2C,"<,|channel>* [:{message}?]"],
	"PASS": [C2S,"<password>"],
		//^rsp: ["461","462"],
	...
	"SERVICE": [S2C|C2S,"<nickname> <reserved> <distribution> <type> <reserved> <info>"],
	"SERVLIST": [C2S,"[<mask>[ <type>]]"],
	"STATS": [C2S|INTERSERVER,"[/query:./[ <server>]]"],
	"SQUERY": [C2S,"<servicename> :{text}?"],
	"SQUIT": [INTERSERVER|C2S,"<server> {comment??:}"],
	"SUMMON-1": [C2S,"<user>[ <server>]"],
	"SUMMON-2": [C2S,"<user>[ <server>[ <channel>]]"],
	...
	"WHOWAS-1": [C2S,"<nickname>[ <#count>[ <server>]]"],
	"WHOWAS-2": [C2S,"<,|nickname>[ <#count>[ <server>]]"],
}
...
spec.rfc1 = {
	...
	"212": msgs["212-RPL_STATSCOMMANDS-1"],
	...
	"407": msgs["407-ERR_TOOMANYTARGETS-1"],
	...
	"436": msgs["436-ERR_NICKCOLLISION-1"],
	...
	"462": msgs["462-ERR_ALREADYREGISTRED-1"],
	...
	"472": msgs["472-ERR_UNKNOWNMODE-1"],
	...
	"502": msgs["502-ERR_USERSDONTMATCH-1"],
...
spec.rfc2 = {
	...
	"002": msgs["001-RPL_YOURHOST"],
	"003": msgs["001-RPL_CREATED"],
	"004": msgs["001-RPL_MYINFO-1"],
	"005": msgs["001-RPL_BOUNCE"],
	"200": msgs["200-RPL_TRACELINK-1"],
	"201": msgs["201-RPL_TRACECONNECTING"],
	"202": msgs["202-RPL_TRACEHANDSHAKE"],
	"203": msgs["203-RPL_TRACEUNKNOWN"],
	"204": msgs["204-RPL_TRACEOPERATOR"],
	"205": msgs["205-RPL_TRACEUSER"],
	"206": msgs["206-RPL_TRACESERVER-2"],
	"208": msgs["208-RPL_TRACENEWTYPE"],
	"209": msgs["209-RPL_TRACECLASS"], //reserved
	"211": msgs["211-RPL_STATSLINKINFO"],
	"212": msgs["212-RPL_STATSCOMMANDS-2"],
	// "213": msgs["213-RPL_STATSCLINE"],
	// "214": msgs["214-RPL_STATSNLINE"],
	// "215": msgs["215-RPL_STATSILINE"],
	// "216": msgs["216-RPL_STATSKLINE"],
	...
	"259": msgs["259-RPL_ADMINEMAIL"],
	"261": msgs["261-RPL_TRACELOG"],
	"262": msgs["262-RPL_TRACEEND"],
	"263": msgs["263-RPL_TRYAGAIN"],
	// "300": msgs["300-RPL_NONE"],
	// "301": msgs["301-RPL_AWAY"],
	"302": msgs["302-RPL_USERHOST"],
	"303": msgs["303-RPL_ISON-2"],
	"305": msgs["305-RPL_UNAWAY"],
	"306": msgs["306-RPL_NOWAWAY"],
	"311": msgs["311-RPL_WHOISUSER"],
	"312": msgs["312-RPL_WHOISSERVER"],
	...
	"323": msgs["323-RPL_LISTEND"],
	"324": msgs["324-RPL_CHANNELMODEIS"],
	"325": msgs["325-RPL_UNIQOPIS"],
	"331": msgs["331-RPL_NOTOPIC"],
	"332": msgs["332-RPL_TOPIC"],
	"341": msgs["341-RPL_INVITING-1"],
	"342": msgs["342-RPL_SUMMONING"],
	"346": msgs["346-RPL_INVITELIST"],
	"347": msgs["347-RPL_ENDOFINVITELIST"],
	"348": msgs["346-RPL_EXCEPTLIST"],
	"349": msgs["347-RPL_ENDOFEXCEPTLIST"],
	"351": msgs["351-RPL_VERSION"],
	"352": msgs["352-RPL_WHOREPLY"],
	"353": msgs["353-RPL_NAMREPLY"],
	//"361": msgs["361-RPL_KILLDONE"], //reserved
	...
	"405": msgs["405-ERR_TOOMANYCHANNELS"],
	"406": msgs["406-ERR_WASNOSUCHNICK"],
	"407": msgs["407-ERR_TOOMANYTARGETS-2"],
	"408": msgs["408-ERR_NOSUCHSERVICE"],
	"409": msgs["409-ERR_NOORIGIN"],
	"411": msgs["411-ERR_NORECIPIENT"],
	"412": msgs["412-ERR_NOTEXTTOSEND"],
	"413": msgs["413-ERR_NOTOPLEVEL"],
	...
	"424": msgs["424-ERR_FILEERROR"],
	"431": msgs["431-ERR_NONICKNAMEGIVEN"],
	"432": msgs["432-ERR_ERRONEOUSNICKNAME"],
	"433": msgs["433-ERR_NICKNAMEINUSE"],
	"436": msgs["436-ERR_NICKCOLLISION-2"],
	"437": msgs["437-ERR_UNAVAILRESOURCE"],
	"441": msgs["441-ERR_USERNOTINCHANNEL"],
	"442": msgs["442-ERR_NOTONCHANNEL"],
	"443": msgs["443-ERR_USERONCHANNEL"],
	"444": msgs["444-ERR_NOLOGIN"],
	...
	"451": msgs["451-ERR_NOTREGISTERED"],
	"461": msgs["461-ERR_NEEDMOREPARAMS"],
	"462": msgs["462-ERR_ALREADYREGISTRED-2"],
	"463": msgs["463-ERR_NOPERMFORHOST"],
	"464": msgs["464-ERR_PASSWDMISMATCH"],
	"465": msgs["465-ERR_YOUREBANNEDCREEP"],
	"466": msgs["466-ERR_YOUWILLBEBANNED"],
	"467": msgs["467-ERR_KEYSET"],
	"471": msgs["471-ERR_CHANNELISFULL"],
	"472": msgs["472-ERR_UNKNOWNMODE-2"],
	"473": msgs["473-ERR_INVITEONLYCHAN"],
	"474": msgs["474-ERR_BANNEDFROMCHAN"],
	"475": msgs["475-ERR_BADCHANNELKEY"],
	"476": msgs["476-ERR_BADCHANMASK"],
	"477": msgs["477-ERR_NOCHANMODES"],
	"478": msgs["478-ERR_BANLISTFULL"],
	"481": msgs["481-ERR_NOPRIVILEGES"],
	"482": msgs["482-ERR_CHANOPRIVSNEEDED"],
	"483": msgs["483-ERR_CANTKILLSERVER"],
	"484": msgs["484-ERR_RESTRICTED"],
	"485": msgs["485-ERR_UNIQOPPRIVSNEEDED"],
	"491": msgs["491-ERR_NOOPERHOST"],
	//"492": msgs["492-ERR_NOSERVICEHOST"], //reserved
	"501": msgs["501-ERR_UMODEUNKNOWNFLAG"],
	"502": msgs["502-ERR_USERSDONTMATCH-2"],
...
//	"LIST": msgs["LIST"],
	...
	"MOTD": msgs["MOTD"],
	"LUSERS": msgs["LUSERS"],
	"SERVLIST": msgs["SERVLIST"],
	"SQUERY": msgs["SQUERY"],
	"WHO": msgs["WHO"],
	"WHOIS": msgs["WHOIS"],
	"WHOWAS": msgs["WHOWAS-2"],
	"KILL": msgs["KILL"],
	"PING": msgs["PING"],
	"PONG": msgs["PONG"],
	"ERROR": msgs["ERROR"],
...
for(var x in msgs){
	try {
		switch(x.charAt(0)){
			case "$": msgs[x] = new Splitter(msgs[x]); break;
			case "_": break
			default: {
		...
		console.log("Errored on entry "+x);
		throw err;
	}
}

///* ATTN: COMMENT THIS OUT FOR PRODUCTION
