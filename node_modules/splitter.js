...
module.exports = Class({
	...
	name: "Splitter",
	//TODO: Test case insensitivity argument
				...
				case "<": { //Spaceless group
					...
					if(pt.length == 1){
						...
						case ":": {
							...
							var right = false, innerMod = "", lb = "(", rb = ")", struct;
							...
							struct = lb+arg+"{"+nom+"}"+innerMod+rb+"|"+lb+"<"+nom+">"+rb;
							mod = mod.replace("?","");
					...
					if(Array.isArray(tk[0])){
						...
						if(tk[0] in ns){
							...
							for(k=0;k<d.length;++k){
								if(!d[k].match("^("+tk[1]+")$")){
									//TODO: Store assertions to throw an error if all fail?
